...
def process_bronze(**kwargs):
    ...
    try:
        ...
        storage_options = {
            ...
            "allow_unsafe_rename": "true",  # Additional MinIO compatibility
            "AWS_S3_ENDPOINT": os.getenv("MINIO_ENDPOINT", "http://minio:9000")  # Redundant for compatibility
        }
...
with DAG(
    ...
    #     task_id='debug_env',
    #     bash_command='echo "JAVA_HOME=$JAVA_HOME" && echo "PATH=$PATH" && /opt/spark/bin/spark-submit --version',
    #     env={
    #         "JAVA_HOME": "/usr/lib/jvm/java-17-openjdk-arm64",
    #         "PATH": "/usr/lib/jvm/java-17-openjdk-arm64/bin:/opt/spark/bin:$PATH"
    #     }
    # )
    ...
    embed_to_chromadb_task = SparkSubmitOperator(
        ...
        application="/opt/spark-jobs/embed_gold_data.py",
    ...
    # # Define the PythonOperator task
    # embed_to_chromadb_task = PythonOperator(
    #     task_id='embed_gold_data_to_chromadb',
    #     python_callable=embed_gold_data
    # )
